...
public class Task0606 {
    ...
    public static void universalMethod(String str, int a, double b){

    }

    public static void universalMethod(String str, char c){

    }

    public static void universalMethod(short s, int a, double b){
